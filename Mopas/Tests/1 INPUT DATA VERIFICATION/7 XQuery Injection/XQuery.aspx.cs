    ...
    public partial class XQuery1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (role != null)
            {
                ...
                // GET /Tests/1 INPUT DATA VERIFICATION/7 XQuery Injection/XQuery.aspx?role=__AI_ixouldfksxkphmb HTTP/1.1
                // Host:localhost
                // ((System.Xml.XmlDocument.SelectNodes((("/root/roles/role[@='" + "__AI_ixouldfksxkphmb") + "']")).GetEnumerator().MoveNext() && (System.Xml.XmlDocument.SelectNodes((("/root/roles/role[@='" + "__AI_ixouldfksxkphmb") + "']")).GetEnumerator().Current != null)) && ((System.Xml.XmlDocument.SelectNodes((("/root/roles/role[@='" + "__AI_ixouldfksxkphmb") + "']")).GetEnumerator().Current.InnerText) == "<script>alert(0)</script>"))
