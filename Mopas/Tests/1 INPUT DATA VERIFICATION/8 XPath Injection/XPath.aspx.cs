    ...
    public partial class XQuery : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (name != null)
            {
                ...
                // GET /Tests/1 INPUT DATA VERIFICATION/8 XPath Injection/XPath.aspx?name=__AI_cmlveedhuhewujv HTTP/1.1
                // Host:localhost
                // ((System.Xml.XmlDocument.SelectSingleNode((("/root/users/user[@name='" + "__AI_cmlveedhuhewujv") + "']")) != null) && (System.Xml.XmlDocument.SelectSingleNode((("/root/users/user[@name='" + "__AI_cmlveedhuhewujv") + "']")).InnerText == "<script>alert(0)</script>"))
